...
#ifndef UNTITLED16_POLINOM_H
#define UNTITLED16_POLINOM_H
...
public:
    ...
    explicit Polinom(std::map<Natural,Rational,Comparator>&);//Конструктор, получающий дерево коэффициентов
    ...
    [[nodiscard]] Natural& get_Degree()const{return *this->hDegree;}//Получение старшей степени многочлена

    [[nodiscard]] std::map<Natural,Rational,Comparator> get_C()const{return this->C;}//Получение дерева коэффициентов многочлена
